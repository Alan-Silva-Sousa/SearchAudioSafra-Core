...
import { Usuario } from './audio/entities/usuario.entity';
import { Permissao } from './audio/entities/permissao.entity';
import { LogAuditoria } from './audio/entities/log-auditoria.entity';
